...
public class Upgrade410to420 implements DbUpgrade {
  ...
  private void persistVswitchConfiguration(Connection conn) {
    ...
    final Map<Long, List<Pair<String, String>>> detailsMap = new HashMap<Long, List<Pair<String, String>>>();
  ...
  private void persistLegacyZones(Connection conn) {
    final List<Long> listOfLegacyZones = new ArrayList<Long>();
    final List<Long> listOfNonLegacyZones = new ArrayList<Long>();
    final Map<String, ArrayList<Long>> dcToZoneMap = new HashMap<String, ArrayList<Long>>();
  ...
  private void fixZoneUsingExternalDevices(Connection conn) {
    ...
    final List<Long> zoneIds = new ArrayList<Long>();
  ...
  private void migrateS3ToImageStore(Connection conn) {
    Long storeId = null;
    final Map<Long, Long> s3_store_id_map = new HashMap<Long, Long>();
  ...
  private void migrateSwiftToImageStore(Connection conn) {
    Long storeId = null;
    final Map<Long, Long> swift_store_id_map = new HashMap<Long, Long>();
